...
('About Us', 'about', '<h2>About Our Mission</h2><p>We are dedicated to providing high-performance, NSF-certified refrigerator water filter replacements that deliver crystal-clear, great-tasting water for every family.</p><h3>Why Choose Us?</h3><ul><li>NSF 42 & 53 certified for harmful contaminant removal</li><li>High-density coconut shell activated carbon</li><li>Save up to 60% compared to OEM prices</li></ul>', 'About Us | FiltersPro', 'Learn about FiltersPro - your trusted source for premium refrigerator water filter replacements.', 'default', 1, 4),

('Contact Us', 'contact', '<h2>Customer Support & Enquiries</h2><p>Need help identifying the exact replacement filter model for your refrigerator? Our technical support team is ready to assist you!</p><h3>Get in Touch</h3><p><strong>Email Support:</strong> support@filterspro.com</p><p><strong>Business Hours:</strong> Monday – Friday, 9:00 AM – 6:00 PM EST</p>', 'Contact Us | FiltersPro', 'Contact FiltersPro for questions about refrigerator water filter replacements, orders, or inquiries.', 'default', 1, 5);
